...
export const metadata = {
  title: 'Second-Hand Handbags - Kleva Handbags',
  description: 'Shop high-quality second-hand handbags at affordable prices',
};
      ...
      <div className="bg-white min-h-screen">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 pb-6 border-b border-neutral-200">
            <h1 className="text-3xl font-bold text-neutral-900 mb-2">Second-Hand Handbags</h1>
            <p className="italic">
              ( Pochi Za Mtumba )
            </p>
